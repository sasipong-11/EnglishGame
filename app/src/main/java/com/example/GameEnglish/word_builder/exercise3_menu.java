...
import com.example.GameEnglish.flash_card.flash_card_menu;

import com.example.GameEnglish.word_builder.easy.ex3_easy_menu;
...
public class exercise3_menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        normal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), flash_card_menu.class);
                startActivity(intent);
            }
        });
