...
public class gridview_flash_card_select_char extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (selectedRows.size() > 0) {
                    ...
                    if(selectedRows.size() != 5 || selectedRows.size() > 5){
                        ...
                        Intent intent = new Intent(gridview_flash_card_select_char.this, flash_card_select_image.class);
