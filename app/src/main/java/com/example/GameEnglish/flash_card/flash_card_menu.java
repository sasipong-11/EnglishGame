...
public class flash_card_menu extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.flash_card_menu);
        ...
        gridviewAdapter = new GridviewAdapter(arrayList,this,"flash_card_game",R.drawable.radius_button_color_ex2,arrayList);
